...
export default function FAQ() {
	...
	return (
		<div className="bg-background dark:bg-black  text-gray-600 dark:text-foreground/90">
			<section className="max-w-7xl mx-auto px-6 py-16 grid md:grid-cols-2 gap-12 items-start">
				...
				<div>
					...
					<SlideInLeftWhenVisible>
						<p className=" mb-6">
							Got questions about BridgeDeck? Explore these FAQs to understand
							how our platform simplifies complaint handling and management.
						</p>
					</SlideInLeftWhenVisible>
					<FadeInWhenVisible>
						<Link href="./contact">
